<x-layout>
    ...
    <main class="container mx-auto px-6 py-12">
        ...
        <div class="mb-16">
            <div class="flex items-center mb-8">
                <div class="w-16 h-16 bg-gradient-to-r from-green-500 to-teal-600 rounded-full flex items-center justify-center mr-4">
                    <i class="fas fa-chart-bar text-white text-2xl"></i>
                </div>
                <div>
                    <h2 class="text-3xl font-bold text-gray-800 mb-2">Technical Skills</h2>
                    <p class="text-gray-600">Validated by certifications and professional experience</p>
                </div>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-gray-600 font-bold">95%</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-3">
                                <div class="bg-purple-600 h-3 rounded-full transition-all duration-1000" style="width: 95%"></div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-gray-600 font-bold">90%</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-3">
                                <div class="bg-blue-600 h-3 rounded-full transition-all duration-1000" style="width: 90%"></div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                <div class="flex items-center">
                                    ...
                                    <span class="font-medium text-gray-700">Cybersecurity</span>
                                </div>
                                <span class="text-gray-600 font-bold">85%</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-3">
                                <div class="bg-red-600 h-3 rounded-full transition-all duration-1000" style="width: 85%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-gray-600 font-bold">88%</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-3">
                                <div class="bg-yellow-600 h-3 rounded-full transition-all duration-1000" style="width: 88%"></div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-gray-600 font-bold">82%</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-3">
                                <div class="bg-green-600 h-3 rounded-full transition-all duration-1000" style="width: 82%"></div>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                <div class="flex items-center">
                                    ...
                                    <span class="font-medium text-gray-700">Machine Learning</span>
                                </div>
                                <span class="text-gray-600 font-bold">75%</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-3">
                                <div class="bg-indigo-600 h-3 rounded-full transition-all duration-1000" style="width: 75%"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mb-16">
            <div class="flex items-center mb-8">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-gray-800 mb-2">My Learning Path</h2>
                    <p class="text-gray-600">Current and planned certifications for professional growth</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-md p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="font-bold text-gray-800 mb-4 text-lg">In Progress</h3>
                        <div class="space-y-4">
                            <div class="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                                <h4 class="font-medium text-gray-800">React Developer</h4>
                            ...
                            <div class="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                                <h4 class="font-medium text-gray-800">Kubernetes Administrator</h4>
                                <p class="text-sm text-gray-600">CNCF</p>
                                <div class="w-full bg-gray-200 rounded-full h-2 mt-2">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="font-bold text-gray-800 mb-4 text-lg">Planned (2024)</h3>
                        <div class="space-y-4">
                            <div class="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-500">
                                <h4 class="font-medium text-gray-800">AWS DevOps Engineer</h4>
                                <p class="text-sm text-gray-600">Amazon Web Services</p>
                            </div>
                            <div class="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-500">
                                <h4 class="font-medium text-gray-800">CISSP</h4>
                                <p class="text-sm text-gray-600">(ISC)²</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="font-bold text-gray-800 mb-4 text-lg">Future Goals</h3>
                        <div class="space-y-4">
                            <div class="bg-purple-50 p-4 rounded-lg border-l-4 border-purple-500">
                                <h4 class="font-medium text-gray-800">AWS Solutions Architect Pro</h4>
                                <p class="text-sm text-gray-600">Amazon Web Services</p>
                            </div>
                            <div class="bg-purple-50 p-4 rounded-lg border-l-4 border-purple-500">
                                <h4 class="font-medium text-gray-800">Google Cloud Architect</h4>
                                <p class="text-sm text-gray-600">Google Cloud</p>
                            </div>
                        </div>
                    </div>
                </div>
