 <nav id="navbar" class="fixed w-full z-50 transition-all duration-300 py-3 sticky top-0 bg-blue-950 text-white">
        <div class="container mx-auto px-4 md:px-6">
            <div class="flex justify-between items-center">
                <!-- Logo -->
                <a href="#" class="flex items-center space-x-2 text-xl font-bold text-white-600">
                    <div>
